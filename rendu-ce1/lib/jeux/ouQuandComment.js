...
exports.QUESTIONS = exports.PHRASES_JEU = exports.PHRASES = exports.MANCHES = void 0;
exports.bilan = bilan;
exports.serie = serie;
...
const PHRASES_JEU = exports.PHRASES_JEU = [{
  avant: 'Le chat dort',
  groupe: 'sous la table',
  apres: '.',
  type: 'ou'
}, {
  avant: 'Les oiseaux volent',
  groupe: 'dans le ciel',
  apres: '.',
  type: 'ou'
}, {
  ...
  avant: '',
  groupe: 'Le soir',
  apres: ', papa lit une histoire.',
  type: 'quand'
}, {
  avant: 'Le train arrive',
  groupe: 'à midi',
  apres: '.',
  type: 'quand'
}, {
