...
exports.PHRASES = exports.MANCHES_LECTURE = exports.MANCHES = void 0;
exports.bilan = bilan;
exports.consigneReglage = consigneReglage;
exports.ecrire = ecrire;
exports.estDemie = void 0;
exports.propositions = propositions;
exports.propositionsCE1 = propositionsCE1;
exports.serie = serie;
exports.verdictLecture = verdictLecture;
exports.verdictReglage = verdictReglage;
/**
...
const MANCHES_LECTURE = exports.MANCHES_LECTURE = 4;

/** Une heure entière ou une demie : 3 ou 3,5. */
const estDemie = moment => moment % 1 !== 0;
exports.estDemie = estDemie;
 ...
 */
function propositions(heure, tirer) {
  const voisines = [heure - 1, heure + 1, heure - 2, heure + 2].filter(h => h >= 1 && h <= 11 && h !== heure);
 ...
 */
function propositionsCE1(moment, tirer) {
  const pieges = estDemie(moment) ? [heureDe(moment), tour(moment + 1), tour(moment - 1), tour(moment + 2)] : [moment + 0.5, 12, tour(moment - 1), tour(moment + 1)];
  const liste = [moment];
  pieges.forEach(x => {
    if (liste.length < 4 && !liste.includes(x)) liste.push(x);
  });
  for (let i = liste.length - 1; i > 0; i -= 1) {
    const j = Math.floor(tirer() * (i + 1));
    [liste[i], liste[j]] = [liste[j], liste[i]];
 ...
 */
function serie(graine = Date.now(), manches = MANCHES, niveau = 'CP') {
...
function verdictLecture(choix, heure) {
 ...
 */
function consigneReglage(heure) {
