...
exports.SORTES = exports.RELATIONS = exports.PHRASES = exports.MANCHES = void 0;
exports.bilan = bilan;
exports.ecrire = void 0;
exports.serie = serie;
...
const RELATIONS = exports.RELATIONS = {
  'm-cm': {
    grande: 'm',
    petite: 'cm',
    facteur: 100
...
const SORTES = exports.SORTES = ['vers-petite', 'vers-grande', 'composee'];
function manche(relation, sorte, tirer) {
  ...
  if (sorte === 'vers-petite') {
    ...
    return {
      relation,
      sorte,
      question: `${n} ${grande} = ? ${petite}`,
      unite: petite,
      bonne: n * facteur,
      choix: [n * facteur, n * facteur / 10, n * facteur * 10]
    };
  }
  if (sorte === 'vers-grande') {
    ...
    return {
      relation,
      sorte,
      question: `${ecrire(n * facteur)} ${petite} = ? ${grande}`,
      unite: grande,
      bonne: n,
      choix: [n, n * 10, n * facteur * 10]
    };
  }
  const a = entre(1, 4);
  ...
  return {
    relation,
    sorte,
    question: `${a} ${grande} ${b} ${petite} = ? ${petite}`,
    unite: petite,
    bonne: a * facteur + b,
    choix: [a * facteur + b, colle === a * facteur + b ? a * facteur + b + facteur : colle, a + b]
  };
}
...
function serie(graine = Date.now()) {
  ...
  const plan = [['m-cm', 'vers-petite'], ['cm-mm', 'vers-petite'], ['km-m', 'vers-petite'], ['m-cm', 'vers-grande'], ['cm-mm', 'vers-grande'], ['km-m', 'vers-grande'], ['m-cm', 'composee'], ['m-cm', 'composee']];
  return plan.map(([r, s]) => {
    const m = manche(r, s, tirer);
    return {
      ...m,
      choix: melanger([...new Set(m.choix)])
    };
  });
}
