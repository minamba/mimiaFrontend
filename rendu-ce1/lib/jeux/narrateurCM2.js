...
exports.bilan = exports.PHRASES = exports.MANCHES = exports.EXTRAITS = void 0;
exports.serie = serie;
...
const EXTRAITS = exports.EXTRAITS = [['Ce matin-là, je me suis levé avant tout le monde. J’ai enfilé mes bottes et je suis sorti dans le jardin encore gris.', 'personnage', false], ['Quand j’ai ouvert la boîte, mon cœur s’est mis à battre : un petit dragon dormait à l’intérieur.', 'personnage', false], ['Nous avions marché toute la journée. Mes jambes me faisaient mal, mais je ne voulais pas me plaindre.', 'personnage', false], ['Je n’oublierai jamais le jour où mon grand-père m’a appris à pêcher.', 'personnage', false], ['Nina se leva avant tout le monde. Elle enfila ses bottes et sortit dans le jardin encore gris.', 'exterieur', false], ['Le vieux marin regardait la mer. Il savait qu’une tempête approchait.', 'exterieur', false], ['Léa cria : « Je suis là, derrière l’arbre ! » Mais personne ne l’entendit.', 'exterieur', true], ['« J’ai trouvé la clé ! » s’écria Samir. Ses amis coururent le rejoindre.', 'exterieur', true]];
function serie(graine = Date.now()) {
  ...
  const manches = [...perso, ...exterieur].map(([question, bonne, dialogue]) => ({
    ...
    choix: [{
      cle: 'personnage',
      libelle: 'Un personnage de l’histoire'
    }, {
      cle: 'exterieur',
      libelle: 'Un narrateur hors de l’histoire'
    }]
  }));
  manches.push({
    consigne: 'auteur',
    ...
    choix: [{
      cle: 'oui',
      libelle: 'Le narrateur, c’est l’auteur'
    }, {
      cle: 'non',
      libelle: 'Le narrateur, c’est le chat'
    }]
  });
