...
exports.bilan = exports.PHRASES = exports.NOMS = exports.MANCHES = exports.LARGEUR = exports.HAUTEUR = exports.ANGLES = void 0;
exports.serie = serie;
...
const NOMS = exports.NOMS = {
  ...
  secantes: 'Ni l’un ni l’autre'
};

/** Le demi-quadrillage de gauche : 4 colonnes, 5 rangs ; la colonne 3 touche l'axe. */
const LARGEUR = exports.LARGEUR = 4;
const HAUTEUR = exports.HAUTEUR = 5;
  ...
  melanger(['perpendiculaires', 'paralleles', 'secantes']).forEach(sorte => {
    liste.push({
      ...
      ecart: {
        perpendiculaires: 90,
        paralleles: 0,
        secantes: au([40, 60, 125])
      }[sorte],
      bonne: sorte,
      choix: ['perpendiculaires', 'paralleles', 'secantes'].map(c => ({
        cle: c,
        libelle: NOMS[c]
      }))
    });
  ...
  while (liste.length < MANCHES) {
    ...
    if (new Set(cles).size === 3) {
      liste.push({
        ...
        choix: melanger(['miroir', 'glisse', 'bas']).map(c => ({
          cle: c,
          libelle: c
        }))
      });
