...
exports.PHRASES_JEU = exports.PHRASES_CE2 = exports.PHRASES = exports.MANCHES = exports.FORMES = exports.ESSAIS_AVANT_AIDE = void 0;
exports.bilan = bilan;
exports.formeDuNe = formeDuNe;
...
const PHRASES_JEU = exports.PHRASES_JEU = [{
  ...
  mots: ['Je', 'mange', 'une', 'pomme.'],
  verbe: 1
}, {
  mots: ['Il', 'aime', 'les', 'épinards.'],
  verbe: 1
}, {
  mots: ['Nous', 'jouons', 'dehors.'],
  verbe: 1
}, {
  mots: ['Tu', 'écoutes', 'la', 'musique.'],
  verbe: 1
}, {
  mots: ['Elle', 'regarde', 'la', 'télé.'],
  verbe: 1
}, {
  mots: ['Le', 'bébé', 'pleure.'],
  verbe: 2
}, {
  mots: ['Vous', 'arrivez', 'tôt.'],
  verbe: 1
}, {
  mots: ['Mon', 'frère', 'travaille.'],
  verbe: 2
}, {
  mots: ['Ils', 'habitent', 'ici.'],
  verbe: 1
}];

/** « n' » devant une voyelle ou un h muet, « ne » sinon. */
function formeDuNe(p) {
...
const FORMES = exports.FORMES = ['negative', 'interrogative', 'exclamative'];
...
function propositions(p, forme) {
  ...
  return [{
    ...
    texte: `Comme ${c} ?`,
    faute: 'point-exclamation'
  }, {
    texte: `${majuscule(c)}.`,
    faute: 'pas-exclamation'
  }];
}
