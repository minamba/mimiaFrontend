...
exports.bilan = exports.TAILLE = exports.PHRASES = exports.PAS = exports.MANCHES = void 0;
...
const TAILLE = exports.TAILLE = 6;
const PAS = exports.PAS = {
  '↑': [0, -1],
  '↓': [0, 1],
  '←': [-1, 0],
  '→': [1, 0]
...
function executer(depart, programme) {
  let [x, y] = depart;
