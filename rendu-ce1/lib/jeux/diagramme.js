...
exports.THEMES = exports.PHRASES = exports.MANCHES = void 0;
exports.bilan = bilan;
exports.serie = serie;
...
const THEMES = exports.THEMES = [{
  titre: 'Les fruits préférés de la classe',
  categories: ['pomme', 'banane', 'fraise', 'poire']
}, {
  titre: 'Le sport préféré de la classe',
  categories: ['foot', 'danse', 'judo', 'natation']
}, {
  titre: 'L’animal préféré de la classe',
  categories: ['chat', 'chien', 'lapin', 'cheval']
}, {
  titre: 'La couleur préférée de la classe',
  categories: ['bleu', 'rouge', 'vert', 'jaune']
}];
