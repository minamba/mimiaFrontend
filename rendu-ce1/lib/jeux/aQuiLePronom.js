...
exports.decouper = exports.bilan = exports.TEXTES = exports.PHRASES = exports.MANCHES = void 0;
exports.serie = serie;
...
const TEXTES = exports.TEXTES = [['Le renard aperçut le corbeau sur sa branche. [Il] tenait un fromage dans son bec.', 'le corbeau', ['le renard', 'le fromage']], ['Léa a prêté son vélo à Tom. [Elle] lui a demandé d’en prendre soin.', 'Léa', ['Tom', 'le vélo']], ['Le chat guettait la souris. Soudain, [il] bondit hors de sa cachette.', 'le chat', ['la souris', 'la cachette']], ['Maman a acheté une tarte. Nous [l’] avons mangée au dessert.', 'la tarte', ['maman', 'le dessert']], ['Le capitaine regarda la mer déchaînée. [Le vieux marin] n’avait jamais vu une telle tempête.', 'le capitaine', ['la mer', 'la tempête']], ['Paul a perdu ses clés dans le jardin. Il [les] a cherchées jusqu’au soir.', 'les clés', ['Paul', 'le jardin']], ['La maîtresse félicita Inès. [Cette élève] avait fait de gros progrès.', 'Inès', ['la maîtresse', 'les progrès']], ['Le chien de Julie aboie quand le facteur passe. [Il] n’aime pas les inconnus.', 'le chien', ['le facteur', 'Julie']], ['Hugo a écrit une lettre à sa grand-mère. [Elle] la lira demain matin.', 'la grand-mère', ['la lettre', 'Hugo']], ['Le lion s’approcha de la rivière. [Le roi des animaux] avait soif.', 'le lion', ['la rivière', 'les animaux']]];
