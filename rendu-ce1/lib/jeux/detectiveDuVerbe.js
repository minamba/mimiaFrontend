...
exports.PHRASES_JEU = exports.PHRASES_CLASSES = exports.PHRASES_CE2 = exports.PHRASES = exports.NOMS_CLASSES = exports.MANCHES = exports.CLASSES = void 0;
exports.bilan = bilan;
exports.phrase = exports.estVerbe = exports.estSujet = void 0;
exports.questionSujet = questionSujet;
exports.serie = serie;
exports.serieCE2 = serieCE2;
/**
...
const PHRASES_JEU = exports.PHRASES_JEU = [{
  mots: ['Le', 'chien', 'aboie', 'dans', 'le', 'jardin.'],
  verbe: 2,
  sujet: [0, 1],
  question: 'aboie'
}, {
  mots: ['Ma', 'petite', 'sœur', 'dessine', 'une', 'maison.'],
  verbe: 3,
  sujet: [0, 1, 2],
  question: 'dessine'
}, {
  mots: ['Les', 'enfants', 'jouent', 'au', 'ballon.'],
  verbe: 2,
  sujet: [0, 1],
  question: 'joue'
}, {
  mots: ['Dans', 'la', 'forêt,', 'le', 'loup', 'court.'],
  verbe: 5,
  sujet: [3, 4],
  question: 'court'
}, {
  mots: ['Nous', 'mangeons', 'des', 'crêpes.'],
  verbe: 1,
  sujet: [0],
  question: 'mange'
}, {
  mots: ['Le', 'soir,', 'papa', 'lit', 'une', 'histoire.'],
  verbe: 3,
  sujet: [2],
  question: 'lit'
}, {
  mots: ['Tom', 'et', 'Léa', 'font', 'un', 'gâteau.'],
  verbe: 3,
  sujet: [0, 1, 2],
  question: 'fait'
}, {
  mots: ['Le', 'vent', 'souffle', 'très', 'fort.'],
  verbe: 2,
  sujet: [0, 1],
  question: 'souffle'
}, {
  mots: ['Mes', 'amis', 'arrivent', 'demain.'],
  verbe: 2,
  sujet: [0, 1],
  question: 'arrive'
}, {
  mots: ['Le', 'boulanger', 'vend', 'du', 'pain.'],
  verbe: 2,
  sujet: [0, 1],
  question: 'vend'
}, {
  mots: ['Ce', 'matin,', 'le', 'chat', 'dort.'],
  verbe: 4,
  sujet: [2, 3],
  question: 'dort'
}, {
  mots: ['La', 'maîtresse', 'écrit', 'au', 'tableau.'],
  verbe: 2,
  sujet: [0, 1],
  question: 'écrit'
}];
...
const phrase = i => PHRASES_JEU[i];

/** Le verbe touché ? Le sujet touché ? */
exports.phrase = phrase;
const estVerbe = (p, i) => i === p.verbe;
exports.estVerbe = estVerbe;
const estSujet = (p, i) => p.sujet.includes(i);

/** Le mot de la fin — le même dans tous les jeux. */
exports.estSujet = estSujet;
...
const CLASSES = exports.CLASSES = ['nom', 'verbe', 'determinant', 'adjectif', 'pronom'];
const PHRASES_CE2 = exports.PHRASES_CE2 = [{
  mots: ['Le', 'petit', 'chat', 'dort.'],
  classes: ['determinant', 'adjectif', 'nom', 'verbe']
}, {
  mots: ['Elle', 'mange', 'une', 'pomme', 'rouge.'],
  classes: ['pronom', 'verbe', 'determinant', 'nom', 'adjectif']
}, {
  mots: ['Nous', 'regardons', 'un', 'grand', 'bateau.'],
  classes: ['pronom', 'verbe', 'determinant', 'adjectif', 'nom']
}, {
  mots: ['Ma', 'sœur', 'porte', 'une', 'robe', 'bleue.'],
  classes: ['determinant', 'nom', 'verbe', 'determinant', 'nom', 'adjectif']
}, {
  mots: ['Il', 'lit', 'un', 'livre', 'amusant.'],
  classes: ['pronom', 'verbe', 'determinant', 'nom', 'adjectif']
}, {
  mots: ['Les', 'oiseaux', 'chantent.'],
  classes: ['determinant', 'nom', 'verbe']
}, {
  mots: ['Tu', 'dessines', 'une', 'maison', 'jaune.'],
  classes: ['pronom', 'verbe', 'determinant', 'nom', 'adjectif']
}, {
  mots: ['Ce', 'gros', 'chien', 'aboie.'],
  classes: ['determinant', 'adjectif', 'nom', 'verbe']
}, {
  mots: ['Ils', 'jouent', 'dans', 'le', 'jardin.'],
  classes: ['pronom', 'verbe', 'autre', 'determinant', 'nom']
}, {
  mots: ['Mon', 'frère', 'range', 'sa', 'chambre.'],
  classes: ['determinant', 'nom', 'verbe', 'determinant', 'nom']
}];
 ...
 */
function serieCE2(graine = Date.now()) {
  const tirer = suite(graine);
  const melanger = liste => {
    const copie = [...liste];
    for (let i = copie.length - 1; i > 0; i -= 1) {
  ...
  return cibles.map(cible => {
    ...
    return {
      phrase: possibles[Math.floor(tirer() * possibles.length)],
      cible
    };
  });
}
const NOMS_CLASSES = exports.NOMS_CLASSES = {
  nom: 'un nom',
  verbe: 'un verbe',
  determinant: 'un déterminant',
  adjectif: 'un adjectif',
  pronom: 'un pronom'
};
const PHRASES_CLASSES = exports.PHRASES_CLASSES = {
