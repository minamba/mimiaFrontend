...
exports.PROPOSITIONS = exports.PREMIERE_MASQUEE = exports.PHRASES = exports.MANCHES = exports.ALVEOLES = void 0;
exports.alveoles = alveoles;
exports.bilan = bilan;
exports.gagnee = gagnee;
...
const ALVEOLES = exports.ALVEOLES = 10;
...
const PREMIERE_MASQUEE = exports.PREMIERE_MASQUEE = 4;

/** Quatre barres proposées : de quoi se tromper sans noyer le choix. */
const PROPOSITIONS = exports.PROPOSITIONS = 4;
 ...
 */
function propositions(manque, tirer) {
  const choix = [manque];
 ...
 */
function verdict(depart, choisi) {
 ...
 */
function alveoles(depart, poses, masquee = false) {
  return Array.from({
    length: ALVEOLES
  }, (_, i) => {
