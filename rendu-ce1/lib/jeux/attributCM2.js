...
exports.bilan = exports.PHRASES = exports.MANCHES = exports.FONCTIONS = exports.A_RECONNAITRE = exports.A_ACCORDER = void 0;
exports.serie = serie;
...
const A_ACCORDER = exports.A_ACCORDER = [['Mes sœurs semblent ___ ce soir.', 'fatiguées', {
  fatigué: 'oubli',
  fatigués: 'genre'
}], ['Ces histoires paraissent ___.', 'vraies', {
  vrai: 'oubli',
  vrais: 'genre'
}], ['Les rues restent ___ toute la nuit.', 'éclairées', {
  éclairé: 'oubli',
  éclairés: 'genre'
}], ['Mon frère est devenu très ___.', 'grand', {
  grande: 'genre',
  grands: 'nombre'
}], ['Les invités sont ___.', 'contents', {
  content: 'oubli',
  contentes: 'genre'
}], ['La soupe semble trop ___.', 'chaude', {
  chaud: 'genre',
  chaudes: 'nombre'
}], ['Tes amies deviennent ___.', 'sérieuses', {
  sérieux: 'genre',
  sérieuse: 'nombre'
}]];

/** [phrase avec le groupe entre crochets, fonction]. */
const A_RECONNAITRE = exports.A_RECONNAITRE = [['Léa est devenue [médecin].', 'attribut'], ['Le ciel paraît [gris].', 'attribut'], ['Ce chat semble [malade].', 'attribut'], ['Il reste [calme].', 'attribut'], ['Léa soigne [les malades].', 'cod'], ['Paul mange [une pomme].', 'cod'], ['Nous regardons [la mer].', 'cod'], ['Elle reste [à la maison].', 'cc']];
