...
exports.bilan = exports.PHRASES_A_ANALYSER = exports.PHRASES = exports.MANCHES = void 0;
exports.serie = serie;
...
const PHRASES_A_ANALYSER = exports.PHRASES_A_ANALYSER = [['Léa mange [une pomme].', 'verbe', false], ['Tom parle [à sa sœur].', 'verbe', false], ['Nous pensons [à nos vacances].', 'verbe', false], ['Il va [à Paris].', 'verbe', true], ['Elle habite [à Lyon].', 'verbe', true], ['[Chaque matin], Léa mange une pomme.', 'phrase', false], ['Tom parle [dans la cour].', 'phrase', false], ['Il travaille [à Paris].', 'phrase', false], ['[Pendant les vacances], nous lisons beaucoup.', 'phrase', false], ['Le chat dort [sur le canapé].', 'phrase', false]];
function serie(graine = Date.now()) {
  ...
  return melanger([...verbe, ...phrase]).map(([texte, fonction, lieu]) => ({
    ...
    choix: [{
      cle: 'verbe',
      libelle: 'Complément du verbe'
    }, {
      cle: 'phrase',
      libelle: 'Complément de phrase'
    }]
  }));
}
