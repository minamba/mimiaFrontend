...
exports.PHRASES = exports.MANCHES_AXE = exports.MANCHES = exports.FIGURES = void 0;
exports.bilan = bilan;
exports.serie = serie;
...
const MANCHES_AXE = exports.MANCHES_AXE = 5;
...
const FIGURES = exports.FIGURES = [{
  nom: 'maison',
  axe: 'v',
  points: [[60, 150], [140, 150], [140, 90], [100, 45], [60, 90]]
}, {
  nom: 'fleche',
  axe: 'h',
  points: [[30, 65], [115, 65], [115, 40], [175, 80], [115, 120], [115, 95], [30, 95]]
}, {
  nom: 'cerf-volant',
  axe: 'v',
  points: [[100, 15], [145, 65], [100, 150], [55, 65]]
}, {
  nom: 't',
  axe: 'v',
  points: [[45, 30], [155, 30], [155, 58], [115, 58], [115, 150], [85, 150], [85, 58], [45, 58]]
}, {
  nom: 'poisson',
  axe: 'h',
  points: [[25, 80], [80, 45], [135, 80], [175, 50], [175, 110], [135, 80], [80, 115]]
}, {
  nom: 'sapin',
  axe: 'v',
  points: [[100, 15], [150, 85], [120, 85], [160, 135], [110, 135], [110, 155], [90, 155], [90, 135], [40, 135], [80, 85], [50, 85]]
}, {
  nom: 'bateau',
  axe: 'v',
  points: [[40, 100], [160, 100], [135, 140], [65, 140]]
}];
...
function triangle(tirer) {
  ...
  const bases = [[[40, 140], [40 + l1, 140], [40, 140 - l2]], [[160, 140], [160 - l1, 140], [160, 140 - l2]], [[40, 20], [40 + l1, 20], [40, 20 + l2]], [[160, 20], [160 - l1, 20], [160, 20 + l2]]];
  return bases[tourne];
}
function serie(graine = Date.now()) {
  ...
  const angles = Array.from({
    length: MANCHES - MANCHES_AXE
  }, () => {
    const sommets = triangle(tirer);
    const lettres = melanger(['A', 'B', 'C']);
    return {
      mode: 'angle',
      sommets: sommets.map((p, i) => ({
        lettre: lettres[i],
        point: p
      })),
      bonne: lettres[0],
