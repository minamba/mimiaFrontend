...
exports.PHRASES = exports.NOMS = exports.MANCHES = exports.ESSAIS_AVANT_AIDE = void 0;
exports.bilan = bilan;
exports.etiquette = etiquette;
exports.motADire = motADire;
exports.nom = nom;
exports.serie = serie;
...
function serie(graine = Date.now()) {
  ...
  const pluriels = melanger(Array.from({
    length: MANCHES
  }, (_, i) => i < MANCHES / 2));
 ...
 */
function motADire(etiquetteChoisie) {
  if (['un', 'une', 'des'].includes(etiquetteChoisie)) return {
    sorte: 'petit-mot',
