...
exports.PHRASES = exports.PARTS = exports.MANCHES_LIRE = exports.MANCHES_COMPARER = exports.MANCHES = exports.ESSAIS_AVANT_AIDE = exports.ERREURS = exports.EGALITES = void 0;
exports.bilan = bilan;
exports.cle = void 0;
...
const MANCHES_LIRE = exports.MANCHES_LIRE = 3;
const MANCHES_COMPARER = exports.MANCHES_COMPARER = 3;
const ESSAIS_AVANT_AIDE = exports.ESSAIS_AVANT_AIDE = 2;
const PARTS = exports.PARTS = [2, 3, 4, 6, 8];
 ...
 */
exports.cle = cle;
const EGALITES = exports.EGALITES = [[{
  n: 1,
  d: 2
}, {
  n: 2,
...
function serieCE2(graine) {
  ...
  melanger(EGALITES).slice(0, MANCHES_COMPARER).forEach(([a, b]) => {
    ...
    liste.push({
      ...
      modele: a,
      fraction: b,
      choix: melanger([b, piege1, piege2])
    });
  });
