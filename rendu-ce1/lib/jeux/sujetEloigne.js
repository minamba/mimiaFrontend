...
exports.PHRASES_JEU = exports.PHRASES = exports.MANCHES = void 0;
exports.bilan = bilan;
...
const PHRASES_JEU = exports.PHRASES_JEU = [{
  avant: 'Les enfants de la classe',
  apres: 'au ballon.',
  bon: 'jouent',
  proche: 'joue',
  autre: 'joues',
  ...
  avant: 'Le vélo des garçons',
  apres: 'une roue crevée.',
  bon: 'a',
  proche: 'ont',
  autre: 'as',
  sujet: 'Le vélo',
  ...
  avant: 'La voiture de mes parents',
  apres: 'vite.',
  bon: 'roule',
  proche: 'roulent',
  autre: 'roules',
...
function serie(graine = Date.now()) {
  ...
  return melanger(PHRASES_JEU).slice(0, MANCHES).map(p => ({
    ...p,
    choix: melanger([p.bon, p.proche, p.autre])
  }));
}
...
const question = p => `Qui est-ce qui ${p.question} ?`;
