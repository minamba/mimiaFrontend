...
exports.SONS = exports.PHRASES = exports.PAR_MANCHE = exports.MOTS = exports.MANCHES = exports.ESSAIS_AVANT_AIDE = exports.CIBLES = void 0;
exports.bilan = bilan;
exports.mot = mot;
exports.serie = serie;
exports.son = son;
...
const PAR_MANCHE = exports.PAR_MANCHE = 6;
const CIBLES = exports.CIBLES = 3;
 ...
 */
const SONS = exports.SONS = [{
  cle: 'a',
  lettre: 'a',
  consigne: 'Pêche les images où tu entends « a », comme dans « chat ».',
  exemple: 'chat'
}, {
  cle: 'i',
  lettre: 'i',
  consigne: 'Pêche les images où tu entends « i », comme dans « lit ».',
  exemple: 'lit'
}, {
  cle: 'o',
  lettre: 'o',
  consigne: 'Pêche les images où tu entends « o », comme dans « vélo ».',
  exemple: 'velo'
}, {
  cle: 'u',
  lettre: 'u',
  consigne: 'Pêche les images où tu entends « u », comme dans « lune ».',
  exemple: 'lune'
}, {
  cle: 'ou',
  lettre: 'ou',
  consigne: 'Pêche les images où tu entends « ou », comme dans « loup ».',
  exemple: 'loup'
}, {
  cle: 'on',
  lettre: 'on',
  consigne: 'Pêche les images où tu entends « on », comme dans « mouton ».',
  exemple: 'mouton'
}, {
  cle: 'an',
  lettre: 'an',
  consigne: 'Pêche les images où tu entends « an », comme dans « orange ».',
  exemple: 'orange'
}, {
  cle: 'ch',
  lettre: 'ch',
  consigne: 'Pêche les images où tu entends le son du début de « chat ».',
  exemple: 'chat'
}, {
  cle: 'r',
  lettre: 'r',
  consigne: 'Pêche les images où tu entends le son du début de « rat ».',
  exemple: 'rat'
}, {
  cle: 'l',
  lettre: 'l',
  consigne: 'Pêche les images où tu entends le son du début de « lune ».',
  exemple: 'lune'
}];
...
function serie(graine = Date.now(), manches = MANCHES) {
  ...
  return melanger(SONS).slice(0, manches).map(s => {
    const avec = MOTS.filter(m => {
      var _m$douteux;
      return m.sons.includes(s.cle) && m.cle !== s.exemple && !((_m$douteux = m.douteux) !== null && _m$douteux !== void 0 && _m$douteux.includes(s.cle));
    });
    const sans = MOTS.filter(m => {
      var _m$douteux2;
      return !m.sons.includes(s.cle) && !((_m$douteux2 = m.douteux) !== null && _m$douteux2 !== void 0 && _m$douteux2.includes(s.cle));
    });
    const poissons = melanger([...melanger(avec).slice(0, CIBLES).map(m => ({
      mot: m.cle,
      cible: true
    })), ...melanger(sans).slice(0, PAR_MANCHE - CIBLES).map(m => ({
      mot: m.cle,
      cible: false
    }))]);
    return {
 ...
 */
function verdict(peches, poissons) {
  ...
  if (cibles.some(c => !peches.includes(c))) return {
    sens: 'manque',
    erreurs: []
  };
  return {
