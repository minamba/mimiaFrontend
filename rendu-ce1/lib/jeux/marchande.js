...
exports.PRODUITS = exports.PHRASES_CE2 = exports.PHRASES_CE1 = exports.PHRASES = exports.MONNAIE_CE2 = exports.MONNAIE = exports.MANCHES = exports.ESSAIS_AVANT_AIDE = exports.BILLETS_CLIENT = void 0;
exports.bilan = bilan;
exports.billetPour = billetPour;
exports.commande = commande;
exports.commandeCE1 = commandeCE1;
exports.consigne = consigne;
exports.consigneCE1 = consigneCE1;
exports.ecrirePiece = void 0;
exports.ecrirePrix = ecrirePrix;
exports.prix = prix;
exports.prixEnMots = prixEnMots;
exports.serie = serie;
exports.serieCE1 = serieCE1;
exports.serieCE2 = serieCE2;
exports.somme = somme;
exports.verdict = verdict;
exports.verdictCE2 = verdictCE2;
/**
...
const PRODUITS = exports.PRODUITS = [{
  cle: 'banane',
  nom: 'banane',
  pluriel: 'bananes',
  prix: 1
...
const BILLETS_CLIENT = exports.BILLETS_CLIENT = [5, 10, 20];
 ...
 */
function serieCE1(graine = Date.now(), manches = MANCHES) {
  const tirer = suite(graine);
...
const MONNAIE_CE2 = exports.MONNAIE_CE2 = [200, 100, 50, 20, 10, 5];

/** « 2 € » ou « 50 c » : ce qui est écrit sur la pièce. */
const ecrirePiece = c => c >= 100 ? `${c / 100} €` : `${c} c`;

/** « 3,45 € » : un prix écrit comme sur une étiquette. */
exports.ecrirePiece = ecrirePiece;
function ecrirePrix(c) {
 ...
 */
function serieCE2(graine = Date.now(), manches = MANCHES) {
  const tirer = suite(graine);
  const liste = [];
  const vus = new Set();
  for (let i = 0; i < manches; i += 1) {
    ...
    vus.add(prix);
    liste.push({
      produit: PRODUITS[Math.floor(tirer() * PRODUITS.length)],
      prix
    });
  }
  return liste;
...
function verdictCE2(posees, prix) {
  const paye = somme(posees);
