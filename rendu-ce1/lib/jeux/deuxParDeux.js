...
exports.PHRASES = exports.MANCHES_DOUBLE = exports.MANCHES = void 0;
exports.bilan = bilan;
exports.propositions = propositions;
exports.reponse = reponse;
exports.resultatDouble = resultatDouble;
exports.resultatMoitie = resultatMoitie;
exports.serie = serie;
...
const MANCHES_DOUBLE = exports.MANCHES_DOUBLE = 4;
 ...
 */
function propositions(mode, n, tirer) {
  const [bon, piege, voisins] = mode === 'double' ? [2 * n, n, [2 * n - 2, 2 * n + 2, 2 * n - 1, 2 * n + 1]] : [n, 2 * n, [n - 1, n + 1, n - 2, n + 2]];
...
function serie(graine = Date.now(), manches = MANCHES) {
  ...
  for (let i = 0; i < manches; i += 1) {
    ...
    liste.push({
      mode,
      n,
      choix: propositions(mode, n, tirer)
    });
  }
  return liste;
}
 ...
 */
function resultatDouble(n) {
  return `${n} et ${n}, ça fait ${2 * n}.`;
}
function resultatMoitie(n) {
